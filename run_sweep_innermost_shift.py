...
def run_sweep_innermost_shift(base_cfg: SimulationConfig) -> list:
    all_results = []
    ...
    for i, shift_m in enumerate(SHIFT_VALUES_M):
        ...
        try:
            results = run_single_sim_with_shift(iter_cfg, shift_m)
...
if __name__ == "__main__":
    ...
    all_results = run_sweep_innermost_shift(cfg)
