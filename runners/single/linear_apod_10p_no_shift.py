"""
Final-baseline reference: 10-period LINEAR apodization, no tooth shifts,
avg cavity width, default n_periods=80, center_mod_depth=4 nm,
simulation_mode="optimization".

Twin of tanh_apod_10p_no_shift.py for direct apodization-shape comparison.
"""
