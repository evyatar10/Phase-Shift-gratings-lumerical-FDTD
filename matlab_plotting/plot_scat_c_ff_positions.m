...
sw   = @(t) fullfile(ROOT, 'scat_w_dscan', 'results', ...
    ['result_N80_TM_avg_Ybox16p0_Zbox8p8' t '_ff.mat']);
sy   = @(t) fullfile(ROOT, 'scat_y_polish', 'results', ...
    ['result_N80_TM_avg_Ybox16p0_Zbox8p8' t '_ff.mat']);
ROOTI = fullfile(fileparts(fileparts(mfilename('fullpath'))), 'results_from_igum');
sz   = @(t) fullfile(ROOTI, 'scat_z_teffmap', 'results', ...
    ['result_N80_avg_Ybox16p0_Zbox8p8' t '_ff.mat']);

% Each set: ctrl file + config files (short labels; T and dP_FF appended from data)
sets = struct( ...
    'suffix', {'', '_dist', '_ray', '_comb', '_stagep', '_final3', '_n47', '_te'}, ...
    'dev', {'TM corr 400, W800, N=80/side', 'TM corr 400, W800, N=80/side', ...
            'TM corr 400, W800, N=80/side', 'TM corr 400, W800, N=80/side', ...
            'TM corr 400, W800, N=80/side', 'TM corr 400, W800, N=80/side', ...
            'TM corr 400, W800, N=80/side', 'TE corr 300, p500, W800, N=80/side'}, ...
    'tag', {'x-position sweep, SiN pillar pair r=80 nm, y=\pm700 nm', ...
            ...
            'comb 47 posts r=89, 270\circ, d=1.8 \mum', ...
            'first TE far field (IGUM 51469)'}, ...
    'ctrl', {crsp(''), c3(''), crsp(''), sh(''), sh(''), sh(''), sh(''), sz('')}, ...
    'files', { ...
      ...
      {sy('_scR89_arr47_X-11815to12611_Y1800to1800_C400_pair'), ...
           'comb N=47 posts, r=89 (program best)'}, ...
      {sz('_scR80_arr2_X0to270_Y700to700_C300_pair'), ...
           'TE + pillar pair [0, 270 nm], r=80'}});
...
for s = 1:numel(sets)
    ...
    dev_line = sprintf('%s — %s, \\lambda_{res} %.2f nm', ...
        sets(s).dev, sets(s).tag, ctrl.resonance_wavelength_nm);
    cols = [0 0 0; lines(n)];
