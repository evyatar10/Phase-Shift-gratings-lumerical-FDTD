...
# IGUM runs Lumerical NATIVELY (no container): paths derive from WORK_DIR,
...
if not os.path.isdir(PROJECT_DIR):
    # Fallback: derive from script location when testing standalone
...
config.USE_GPU        = True   # IGUM has GPUs — opposite of Zeus override
